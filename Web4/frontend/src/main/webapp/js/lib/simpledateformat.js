...
(function() {
	...
	SimpleDateFormat = function(formatString, language) {
		this.formatString = formatString;
        this.language = language || 'en';
	};

    SimpleDateFormat.languages = {
        'en': {
			...
			if (quotedString) {
				...
				switch (patternLetter) {
					...
					case "F":
						...
						break;
					case "E":
						rawData = SimpleDateFormat.languages[this.language].dayNames[date.getDay()];
						break;
					case "a":
				...
				switch (types[patternLetter]) {
					...
					case MONTH:
						if (numberOfLetters >= 3) {
							formattedString += formatText(SimpleDateFormat.languages[this.language].monthNames[rawData], numberOfLetters, numberOfLetters);
						} else {
