...
import com.fitbank.ifg.swing.ColoredJLabel;
...
public class ZebraJTable extends javax.swing.JTable {
    ...
    public java.awt.Component prepareRenderer(
        ...
        if (drawStripes && !isCellSelected(row, col) && c != null
                && !(c instanceof ColoredJLabel)) {
